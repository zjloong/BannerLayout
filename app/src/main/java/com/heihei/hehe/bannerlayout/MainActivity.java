package com.heihei.hehe.bannerlayout;
...
public class MainActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        vp = (BannerLayout) findViewById(R.id.vp);

        vp.setOnPagerClickListener(new BannerLayout.OnPagerClickListener() {
            @Override
